...
vim.keymap.set(
	...
	"<Down>",
	"v:count == 0 ? 'gj' : 'j'",
	{ expr = true, silent = true, desc = "Move cursor down by screen line" }
)
vim.keymap.set(
	"n",
	"<Up>",
	"v:count == 0 ? 'gk' : 'k'",
	{ expr = true, silent = true, desc = "Move cursor up by screen line" }
)
vim.keymap.set("i", "<Down>", "<C-o>gj", { silent = true, desc = "Move cursor down by screen line" })
vim.keymap.set("i", "<Up>", "<C-o>gk", { silent = true, desc = "Move cursor up by screen line" })
vim.keymap.set("n", "<Esc>", "<cmd>nohlsearch<CR>")
vim.keymap.set("n", "\\", "<CMD>:sp<CR>", { desc = "Split window horizontally" })
vim.keymap.set("n", "|", "<CMD>:vsp<CR>", { desc = "Split window vertically" })
vim.keymap.set("n", "<leader>tt", "<cmd>term<CR>", { desc = "Open terminal" })
vim.keymap.set("n", "<leader>ts", "<cmd>split | term<CR>", { desc = "Open split terminal" })
-- lua dev
